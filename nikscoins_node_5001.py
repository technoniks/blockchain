...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Nikhil', amount = 10)
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'The nodes had different chains so the chain replaced by longest chain',
